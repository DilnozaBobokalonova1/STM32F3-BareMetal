...
char uart2_read(void) {
	...
	while (!(USART2->ISR & RX_NE)) {
		...
		has been transferred to the USART_RDR register. It is cleared by a read
		to the USART_RDR register. The RXNE flag can also be cleared by writing 1
		to the RXFRQ in the USART_RQR register.
		An interrupt is generated if RXNE=1 in the USART_CR1 register.
